...
public class Nacionalidad  implements java.io.Serializable {
    ...
    public Nacionalidad(int id, String descripcion, String pais, Date actualizadoEn, String actualizadoPor) {
        this.id = id;
    ...
    public Nacionalidad(int id, String descripcion, String pais, Date actualizadoEn, String actualizadoPor, Set personas) {
       this.id = id;
       this.descripcion = descripcion;
       this.pais = pais;
       this.actualizadoEn = actualizadoEn;
